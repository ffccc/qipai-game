...
<head>
    ...
    <title>“<%=CxGame.GetUserNameByUserID(Request("id")) %>”清零逃率记录</title>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">目前操作功能：清零逃率记录</td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    <% 
        ...
        Sub Main()
            ...
            Dim fields
            fields = "RecordID,CollectDate,ClientIP,KindID,CurFlee,MasterID,Reason"
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7">
                <tr align="center" class="bold">
                    ...
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('CurFlee',this)">清零前逃跑次数</a></th>
