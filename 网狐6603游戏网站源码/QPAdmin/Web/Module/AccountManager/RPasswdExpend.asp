...
<head>
    ...
    <title>“<%=CxGame.GetUserNameByUserID(Request("id")) %>”历史改密码记录</title>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">前操作功能：历史改密码记录</td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    <% 
        ...
        Sub Main()
            ...
            Dim fields
            fields = "RecordID,CollectDate,ClientIP,ReLogonPasswd,ReInsurePasswd,OperMasterID,UserID"
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box">
                <tr align="center" class="bold">
                    ...
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('ReLogonPasswd',this)">登录密码</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('ReInsurePasswd',this)">银行密码</a></th>
                ...
                <tr align="center" class="<%=className %>" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                    ...
                    <td>
                        <% If rs(3,i) <> "" Then %>
                        <a href="javascript:void(0)" class="l" onclick="javascript:openWindow('RPasswdExpendConfirm.asp?id=<%=rs(0,i) %>&UserID=<%=rs(6,i) %>&Type=1',500,200)">********</a>&nbsp;&nbsp;
                        <% End If %>
                    </td>
                    <td>
                        <% If rs(4,i)<>"" Then %>
                        <a href="javascript:void(0)" class="l" onclick="javascript:openWindow('RPasswdExpendConfirm.asp?id=<%=rs(0,i) %>&UserID=<%=rs(6,i) %>&Type=2',500,200)">********</a>&nbsp;&nbsp;
                        <% End If %>
                    </td>
