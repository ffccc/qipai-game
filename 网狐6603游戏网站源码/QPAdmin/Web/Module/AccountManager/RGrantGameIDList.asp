...
<head>
    ...
    <title>“<%=CxGame.GetUserNameByUserID(Request("id")) %>”赠送靓号记录</title>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">目前操作功能：赠送靓号记录</td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    <% 
        ...
        Sub Main()
            ...
            Dim fields
            fields = "RecordID,CollectDate,ClientIP,CurGameID,ReGameID,IDLevel,MasterID,Reason"
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7">
                <tr align="center" class="bold">
                    <th class="listTitle"><a class="l1"  href="" onclick="GetOrder('CollectDate',this)">赠送日期</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('ClientIP',this)">赠送地址</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('CurGameID',this)">原游戏ID</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('ReGameID',this)">赠送游戏ID</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('IDLevel',this)">靓号等级</a></th>
