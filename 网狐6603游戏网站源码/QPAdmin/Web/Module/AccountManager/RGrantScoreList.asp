...
<head>
    ...
    <title>“<%=CxGame.GetUserNameByUserID(Request("id")) %>”赠送积分记录</title>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">目前操作功能：赠送积分记录</td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    <% 
        ...
        Sub Main()
            ...
            Dim fields
            fields = "RecordID,CollectDate,ClientIP,KindID,CurScore,AddScore,MasterID,Reason"
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7">
                <tr align="center" class="bold">
                    ...
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('CurScore',this)">赠送前积分</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('AddScore',this)">赠送积分</a></th>
