...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">目前操作功能：清零积分</td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    <% 
        ...
        Sub Save()
            ...
            Call ConnectGame(dname)
                For i=0 To UBound(UserArr)
                   re = GameConn.execute("WSP_PM_GrantClearScore "&masterID&",'"&clientIP&"',"&UserArr(i)&","&kindID&",'"&reason&"'")(0)
                Next                    
            Call CloseGame()
            If re<>"" Then
                CxGame.MessageBoxClose(re)
            Else
                CxGame.MessageBoxClose("积分清零成功！")
            End If
