...
<head>
    ...
    <title>“<%=CxGame.GetUserNameByUserID(Request("id")) %>”赠送经验记录</title>
...
<body>
    <!-- 头部菜单 Start -->
     <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">目前操作功能：赠送经验记录</td>
        </tr>
    </table>
    ...
    <% 
        ...
        Sub Main()
            ...
            Dim fields
            fields = "RecordID,CollectDate,ClientIP,CurExperience,AddExperience,MasterID,Reason"
            ...
            With Page
	            ...
	            .Table="RecordGrantExperience"			'表名
    ...
    <form name="myformList" method="post" action="">
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7">
                <tr class="bold">
                    <th class="listTitle1"><a class="l1"  href="" onclick="GetOrder('CollectDate',this)">赠送日期</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('ClientIP',this)">赠送地址</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('CurExperience',this)">赠送前经验</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('AddExperience',this)">赠送经验</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('MasterID',this)">管理员</a></th>
                    <th class="listTitle"><a class="l1"  href="" onclick="GetOrder('Reason',this)">赠送原因</a></th>
                </tr>
                <% 
                    If IsNull(rs) Then
                ...
                %>
                <tr class="list_white" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#dddddd';this.style.cursor='default';"
                    onmouseout="this.style.backgroundColor=currentcolor">
                    <td><%=rs(1,i) %></td>
                    <td><%=rs(2,i) %></td>
                    <td><%=rs(3,i) %></td>
                    <td><%=rs(4,i) %></td>
                    <td><%=GetQPAdminName(rs(5,i)) %></td>
                    <td><%=rs(6,i) %></td>
                </tr>
                <% 
                    Next
