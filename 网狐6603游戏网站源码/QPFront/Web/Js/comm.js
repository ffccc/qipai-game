...
/** 显示信息提示网页对话框										*/
function showDialog2(width, height, url) {
    var feature = "dialogHeight:" + height + ";dialogWidth:" + width + ";center:yes;scroll:no;status:no;resizable:yes;edge:raised;help:no;unadorned:no";
    var returnValue = window.showModalDialog(url, "游戏家园提醒您", feature);
    return returnValue;
}
