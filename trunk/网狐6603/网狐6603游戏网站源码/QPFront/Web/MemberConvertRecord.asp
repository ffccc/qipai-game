	            ...
	            <div class="title f14 bold lan">兑换记录</div>
                    ...
                    <% 
                        ...
                        Sub Main()
                            ...
                            queryCondition = "UserID="&Session("UserID")&" And (CollectDate between '"&startDate&"' And '"&endDate&"')"
                            
                            Dim fields
                            fields = "RecordID,CollectDate,ConvertPresent,CurPresent,CurInsureScore,IsGamePlaza,ClientIP,ServerID"    
                    ...
                    <tr align="center" class="<%=className %>">
                        ...
                        <td><%=rs(6,i) %></td>  
                        <td><%=CxGame.GetRoomNameByRoomID(rs(7,i)) %></td>
                    </tr>
                    <% 
                        Next
                        End If
