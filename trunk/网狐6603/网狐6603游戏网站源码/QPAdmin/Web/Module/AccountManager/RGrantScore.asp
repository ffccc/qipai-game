...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">目前操作功能：赠送积分</td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    <% 
        ...
        Sub Save()
            ...
            Dim UserArr,i,addScore,reason,masterID,clientIP,scoreList,scoreArr
            addScore = CxGame.SqlCheckNum(Request("in_AddScore"))
            ...
            Call ConnectGame(dname)
                For i=0 To UBound(UserArr)
                    GameConn.execute("WSP_PM_GrantGameScore "&masterID&",'"&clientIP&"',"&UserArr(i)&","&kindID&","&addScore&",'"&reason&"'")
                Next                    
            Call CloseGame()            
            CxGame.MessageBoxClose("赠送积分成功！")
        End Sub
    ...
    <script type="text/javascript">
        function CheckForm()
        {
            var addScore = document.form1.in_AddScore.value.trim();
    ...
    <form name="form1" method="post" action='?action=save&userlist=<%=request("UserID") %>' onsubmit="return CheckForm()">
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
	        ...
	        <tr>
	            <td class="listTdLeft">赠送积分数目：</td>
	            <td>
	                <input name="in_AddScore" type="text" class="text" />            
	            </td>
	        </tr>
	        <tr>
