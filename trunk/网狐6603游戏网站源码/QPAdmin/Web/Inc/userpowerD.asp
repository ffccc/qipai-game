<div class="settingDiv settingtd" >
    <div class="settingDiv_l">用户权限：</div>
...
<div class="settingDiv settingtd" >
    <div class="settingDiv_l">管理级别：</div>
    <div class="settingDiv_r">
	    <div class="m1">
            ...
            <input name="in_MasterOrder" id="in_MasterOrder2" type="radio" value="1"<% If rs("MasterOrder")=1 Then %> checked='checked'<% End If %> /><span style="color:#105399;font-weight:bold;"><label for="in_MasterOrder2">内部管理员</label></span>
            <input name="in_MasterOrder" id="in_MasterOrder3" type="radio" value="2"<% If rs("MasterOrder")=2 Then %> checked='checked'<% End If %> /><span style="color:#cd6a00;font-weight:bold;"><label for="in_MasterOrder3">外部管理员</label></span>   
	    </div>			
    </div>
</div> 

<div class="settingDiv settingtd" >
    <div class="settingDiv_l">管理权限：</div>
    <div class="settingDiv_r">
	    <div class="m1">
		    <table border="0">
            <tr>
