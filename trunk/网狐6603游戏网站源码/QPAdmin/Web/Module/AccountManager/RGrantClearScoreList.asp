...
<head>
    ...
    <title>“<%=CxGame.GetUserNameByUserID(Request("id")) %>”清零积分记录</title>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">目前操作功能：清零积分记录</td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    <% 
        ...
        Sub Main()
            ...
            Dim fields
            fields = "RecordID,CollectDate,ClientIP,KindID,CurScore,MasterID,Reason"
            ...
            With Page
	            ...
	            .Table="RecordGrantClearScore"			'表名
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7">
                <tr align="center" class="bold">
                    <th class="listTitle1"><a class="l1"  href="" onclick="GetOrder('CollectDate',this)">清零日期</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('ClientIP',this)">清零地址</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('KindID',this)">游戏</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('CurScore',this)">清零前积分</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('MasterID',this)">管理员</a></th>
                    <th class="listTitle"><a class="l1"  href="" onclick="GetOrder('Reason',this)">清零原因</a></th>
                </tr>
                <% 
                    Dim className
                    If IsNull(rs) Then
