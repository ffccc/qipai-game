    ...
    <script type="text/javascript">
        $(document).ready(function(){
           ...
           $.formValidator.initConfig({formid:"form1",alertmessage:true,onerror:function(msg){alert(msg)}});
            $("#txtScore").formValidator().inputValidator({min:1000,type:"number",onerror:"非常抱歉，您每笔存入数目最少 1000 金币！"})
                .regexValidator({regexp:"intege1",datatype:"enum",onerror:"存入的金币必须为整数，并且不能大于现金数目！"});            
        })
    </script>
</head>
<body>
				...
				<!--存款开始-->
	              ...
	              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="80%"><input type="text" id="txtScore" name="txtScore" class="text" value="<%=Session("Score") %>" /></td>
                    </tr>
                    <tr>
                      <td align="right">备注信息：</td>
                      <td><textarea id="txtNode" name="txtNode" rows="5" wrap="virtual" class="beizhu" ></textarea></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        <input name="button22" type="submit" class="bnt lan bold" value="存入金币" hidefocus="true"/>
                        <input type="hidden" name="InsureIn" value="true" />
                      </td>
                    </tr>
                  </table> 
                  <br />
