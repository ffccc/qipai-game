...
//高级规则
#define SR_DYNAMIC_JOIN				0x00000010							//动态加入
#define SR_OFFLINE_TRUSTEE			0x00000020							//断线代打
#define SR_AVERT_CHEAT_MODE			0x00000040							//隐藏信息
#define SR_ALLOW_ANDROID_USER		0x00000080							//允许机器
