...
<head>
    ...
    <title>“<%=CxGame.GetUserNameByUserID(Request("id")) %>”魅力兑换记录</title>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">目前操作功能：魅力兑换记录</td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    <% 
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7">
                <tr align="center" class="bold">
                    <th class="listTitle1"><a class="l1"  href="" onclick="GetOrder('CollectDate',this)">兑换日期</a></th>
