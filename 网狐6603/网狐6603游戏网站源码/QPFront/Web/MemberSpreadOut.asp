	            ...
	            <div class="title f14 bold lan">结算明细查询 </div>
                    ...
                    <% 
                        ...
                        Sub Main()
                            ...
                            Dim fields
                            fields = "RecordID,CollectDate,Score,TypeID,InsureScore,CollectNote"    
                    ...
                    <tr align="center" class="<%=className %>">
                        <td><%=rs(1,i) %></td>
                        <td><%=FormatNumber(-CCur(rs(2,i)),0,0) %></td>
                        <td><%=FormatNumber(CCur(rs(4,i)),0,0) %></td>
                        <td><%=FormatNumber(-CCur(rs(2,i))+CCur(rs(4,i)),0,0) %></td>
